...
#define radius 2.5
#define quality 1.0
#define divider 158.0
#define maxSample 10.0
#define texelSize vec2(1.0 / resolution.x * (radius * quality), 1.0 / resolution.y * (radius * quality))
...
vec3 flowShader(vec4 centerCol) {
...
void main() {
	...
	vec3 color = flowShader(centerCol);
